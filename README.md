...
>>  The output of [BS-Seeker2](http://pellegrini.mcdb.ucla.edu/BS_Seeker2/). The CX report file generated by Bismark can be converted to CGmap format by CGmaptools [bismark2cgmap](https://cgmaptools.github.io/cgmaptools_documentation/file-manipulation.html).
```
...
>>contain the gene names and gene expression values
```
AT1G01310       0.152868
AT1G01320       9.06088
AT1G01340       14.1157
