...
> 1. DNA Methylation
>>  CGmap.gz file (need gzip compressed format) is the output of [BS-Seeker2](http://pellegrini.mcdb.ucla.edu/BS_Seeker2/). The CX report file generated by Bismark can be converted to CGmap format by CGmaptools [bismark2cgmap](https://cgmaptools.github.io/cgmaptools_documentation/file-manipulation.html).
```
